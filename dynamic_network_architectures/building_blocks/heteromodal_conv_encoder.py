...
class HeteromodalConvEncoder(nn.Module):
    def __init__(
        ...
        # expect pool to be "conv"!! TODO select like in the other blocks
        conv_stride = strides[0]

        self.heteromodel_block = HeteromodalInputBlock(
            n_conv_per_stage[0],
            conv_op,
            input_channels,
    ...
    def compute_conv_feature_map_size(self, input_size):
        output = np.int64(0)
        output += self.heteromodel_block.compute_conv_feature_map_size(input_size)
